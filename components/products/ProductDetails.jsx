...
import MuiBreadCrumps from "../layouts/BreadCrumbs";
...
const ProductDetails = ({product}) => {
  // For add to cart function from cart context
  const  {addItemToCart}  = useContext(CartContext)
    // Bread Crumbs Navigation 
    const breadCrumbs=[
      {name:"Home",url:"/"},
      {name:`${product.name.substring(0,30)}...`,url:`product/${product._id}`},
    ]
  ...
  return (
    <>
    <MuiBreadCrumps breadCrumbs={breadCrumbs}/>
            ...
            <aside>
              <div className="border border-gray-200 shadow-sm p-3 text-center rounded mb-5">
                ...
                ref={imgRef}
                  ...
                  src={product?.images[0]?product?.images[0].url:"/images/default_product.jpg"}
